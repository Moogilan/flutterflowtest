    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'company':
          ...
          break;
        case 'fac':
          result.fac.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltList, const [const FullType(String)]))
              as BuiltList<Object>);
          break;
        case 'fav':
          result.fav.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(
                    DocumentReference, const [const FullType(Object)])
              ])) as BuiltList<Object>);
...
class _$UserRecord extends UserRecord {
  ...
  @override
  final BuiltList<String> fac;
  @override
  final BuiltList<DocumentReference<Object>> fav;
  @override
...
class UserRecordBuilder implements Builder<UserRecord, UserRecordBuilder> {
  ...
  ListBuilder<String> _fac;
  ListBuilder<String> get fac => _$this._fac ??= new ListBuilder<String>();
  set fac(ListBuilder<String> fac) => _$this._fac = fac;

  ListBuilder<DocumentReference<Object>> _fav;
  ListBuilder<DocumentReference<Object>> get fav =>
      _$this._fav ??= new ListBuilder<DocumentReference<Object>>();
  set fav(ListBuilder<DocumentReference<Object>> fav) => _$this._fav = fav;
  ...
  UserRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _accType = $v.accType;
      _company = $v.company;
      _fac = $v.fac?.toBuilder();
      _fav = $v.fav?.toBuilder();
